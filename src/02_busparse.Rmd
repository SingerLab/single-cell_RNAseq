---
title: "WD2411 - Single-cell RNA-seq expression analysis"
output:
  html_document:
    theme: united
    df_print: kable
...
This is a summary of the analysis of a well-differentiated liposarcoma, that was sampled at two regions, each with a different liposarcoma subtype, at gross pathology WD2311_A had similar features to lipopma like, and WD2311_C had sclerosing liposarcoma features. 

We start by aligning quantifying transcription using `kallisto bus` on [Gencode v30](https://www.gencodegenes.org)) transcripts that were back-mapped onto GRCh37.  Expression analysis was carried out using the `BUSpaRse` [tutorial](https://bustools.github.io/BUS_notebooks_R/10xv3.html) for 10X v3 chemistry.


```{bash, eval=FALSE}
## run kallisto bus on sample A
bsub -Is -n 8 -M 34 -W 89 kallisto bus -i /work/singer/gularter/genomes/homo_sapiens/Ensembl/GRCh37.p13/Sequence/kallisto_index/gencode.v30 -o WD2311_A_03 -x 10xv3 -t 8 rawdata//Sample_WD2311_A_IGO_09818_1/WD2311_A_IGO_09818_1_S12_L001_R1_001.fastq.gz rawdata//Sample_WD2311_A_IGO_09818_1/WD2311_A_IGO_09818_1_S12_L001_R2_001.fastq.gz rawdata//Sample_WD2311_A_IGO_09818_1/WD2311_A_IGO_09818_1_S12_L002_R1_001.fastq.gz rawdata//Sample_WD2311_A_IGO_09818_1/WD2311_A_IGO_09818_1_S12_L002_R2_001.fastq.gz

## Sort, with 8 threads
bustools sort -o ./WD2311_A_03/WD2311_A_03.bus -t 8 ./WD2311_A_03/output.bus

## Convert BUS file to text
bustools text -o ./WD2311_A_03/WD2311_A_03.bus.txt ./WD2311_A_03/WD2311_A_03.bus
     
bsub -Is -n 8 -M 34 -W 89 kallisto bus -i /work/singer/gularter/genomes/homo_sapiens/Ensembl/GRCh37.p13/Sequence/kallisto_index/gencode.v30 -o WD2311_C_03 -x 10xv3 -t 8 rawdata//Sample_WD2311_C_IGO_09818_2//WD2311_C_IGO_09818_2_S13_L001_R1_001.fastq.gz rawdata//Sample_WD2311_C_IGO_09818_2//WD2311_C_IGO_09818_2_S13_L001_R2_001.fastq.gz rawdata//Sample_WD2311_C_IGO_09818_2//WD2311_C_IGO_09818_2_S13_L002_R1_001.fastq.gz rawdata//Sample_WD2311_C_IGO_09818_2//WD2311_C_IGO_09818_2_S13_L002_R2_001.fastq.gz

## Sort, with 8 threads
bustools sort -o ./WD2311_C_03/WD2311_C_03.bus -t 8 ./WD2311_C_03/output.bus

## Convert BUS file to text
bustools text -o ./WD2311_C_03/WD2311_C_03.bus.txt ./WD2311_C_03/WD2311_C_03.bus
...
kallisto.dir <- file.path("/work/singer/gularter/genomes/homo_sapiens/Ensembl/GRCh37.p13/Sequence/kallisto_index/")
gencodeV30 <- file.path(kallisto.dir, "gencode.v30lift37.transcripts.dd.fa")
tr2g <- transcript2gene(fasta_file = gencodeV30, kallisto_out_path = "WD2311_A_03/")

## Barcode whitelist
whitelist.file <- file.path(kallisto.dir, "3M-february-2018.txt.gz")
whitelist_v3 <- fread(whitelist.file, header = FALSE)$V1
length(whitelist_v3)

## Load the WD2311_A dataset
res_mat <- make_sparse_matrix("WD2311_A_03/WD2311_A_03.bus.txt",
                              tr2g = tr2g, est_ncells = 4e4,
...
## rank based method to call cells and empty drops
bc_rank <- barcodeRanks(res_mat)

pdf("bc_ranc_keen_inflection.pdf", width = 12, height = 12)
...
WD2311.A <- CreateSeuratObject(res_mat, min.cells = 3) %>% 
...
pSeurat allows you to easily explore QC metrics and filter cells based on any user-defined criteria. A few QC metrics [commonly used](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4758103/) by the community include
